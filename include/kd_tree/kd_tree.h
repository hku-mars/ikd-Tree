...
struct PointType_CMP{
    ...
    bool operator()(const PointType_CMP & a, const PointType_CMP & b){
...
private:
    ...
    bool point_cmp_x(PointType a, PointType b); 
    bool point_cmp_y(PointType a, PointType b); 
    bool point_cmp_z(PointType a, PointType b); 
